if [[ "$#" -lt 1 ]]; then
  ...
  if [[ $1 -eq $2 && $1 -eq $3 ]]; then
	...
	echo "$1 is equal to $2 and less than $3"
  elif [[ $1 -eq $2 && $1 -gt $3 ]]; then
	echo "$1 is equal to $2 and greater than $3"
  elif [[ $1 -lt $2 && $1 -eq $3 ]]; then
  	echo "$1 is less than $2 and is equal to $3"
  elif [[ $1 -lt $2 && $1 -lt $3 ]]; then
  	echo "$1 is less than $2 and less than $3"
  	...
  	echo "$1 is greater than $2 and less than $3"
